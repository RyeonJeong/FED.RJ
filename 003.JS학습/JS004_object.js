...
var MV_KYJ = {
    ...
    trailer: function () {
        ...
        document.body.innerHTML +=
            '<div id="mv">' +
            '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Ceoe2wf-bbo?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>' +
            '<span class="cbtn">×</span>' +
            '</div>';
        ...
        // 닫기버튼 세팅
        var cbtn = document.getElementsByClassName("cbtn")[0];
        // 클래스요소를 선택할때 순번선택 필수!( 컬렉션 순번 첫번째0 )
        cbtn.style.position = "absolute";
        cbtn.style.top = "0";
        cbtn.style.right = "-70px";
        cbtn.style.width = "50px";
        cbtn.style.height = "50px";
        cbtn.style.background = "#ccc";
        cbtn.style.boxShadow = "1px 1px 10px #000";
        cbtn.style.textAline = "center";
        cbtn.style.fontSize = "40px";
        cbtn.style.fontWeight = "blod";
