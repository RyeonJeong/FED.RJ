...
$(function () { /// jQB ////////////////////////
  ...
  //    복귀애니메이션 이동한다.
  // 단, 실제 left 값을 구하면 px단위를 리턴하므로 기준값을
  //    화면의 width px 값으로 하면된다!!!
  ...
  $(".slide").on("dragstop", function () {
    ...
    // 3. -110% 와 -90% 사이 범위이면 원래위치인 -100%로 복귀애니메이션 이동한다.
    else {
